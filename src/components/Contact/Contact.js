...
function Contact() {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText("sejalyadav122@gmail.com");
    setShowTooltip(true);
    setTimeout(() => {
          ...
          <div className="BigCard">
            <Email>
              <div style={{ display: 'flex', alignItems: 'center', columnGap: '20px', rowGap: '10px', flexWrap: 'wrap', justifyContent: 'center' }} >
                <span>sejalyadav122@gmail.com</span><br></br>
                <span>+91 7069122988</span>
                <Tooltip
                  PopperProps={{
                    disablePortal: true,
                  }}
              ...
              <a
                ...
                href="mailto:sejalyadav122@gmail.com"
                target="_blank"
