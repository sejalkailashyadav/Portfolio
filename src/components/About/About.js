      ...
      <div className="Container">
        ...
        <div className="BigCard">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
              Hello! I'm <strong>Sejal Yadav</strong>, a Software Developer specializing in MongoDB, Express, React.js, Node.js, Nest.js, Laravel and JavaScript. Passionate about creating dynamic, high-performing applications.
            </ScrollAnimation>
